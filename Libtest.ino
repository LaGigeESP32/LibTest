/*
Heap libre : 222996 octets
Heap minimum : 215068 octets
Bloc max allocable : 110580 octets
...
void setup() {
  ...
  wifiMgr.Name("LibTest");   // Nom du projet (pour AP + page web)
  ...
  wifiMgr.localOTA(server,"Admin", "Coucou12");
...
server.on("/", HTTP_GET, [](AsyncWebServerRequest *req) {
    ...
    res->printf(
        ...
        "<h2>ESP32 Diagnostic H24 MAJ Local</h2>"
        "<p><b>Wi-Fi :</b> %s</p>"
        "<p><b>IP :</b> %s</p>"
        "<p><b>RSSI :</b> %d dBm</p>"
        "<hr>"
        ...
        "SDK : %s</p>"
        "<hr>"
        "<a href='/wifi'>Configurer le Wi-Fi</a><br>"
        "<a href='/httpupdate'>Update http</a>"
...
server.on("/httpupdate", HTTP_GET, [](AsyncWebServerRequest *req) {
    AsyncResponseStream *res = req->beginResponseStream("text/html");
    wifiMgr.startOtaTask();
